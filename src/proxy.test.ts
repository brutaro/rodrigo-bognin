...
describe("fronteira pública", () => {
  ...
  it.each(["/", "/projetos", "/fontes/base-consolidada", "/notas-fiscais", "/publicacoes/x", "/api/backups/files", "/api/files/x/download", "/api/projects/x/files", "/api/sources/consolidated", "/api/reports/projects/x", "/api/reports/global"])("protege %s", (path) => {
