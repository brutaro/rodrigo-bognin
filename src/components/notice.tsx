const messages: Record<string, { tone: string; text: string }> = {
  "published": { tone: "border-emerald-200 bg-emerald-50 text-emerald-900", text: "Publicação criada. Esta versão agora é imutável." },
  ...
  "narrative-saved": { tone: "border-emerald-200 bg-emerald-50 text-emerald-900", text: "Narrativa salva no ambiente local." },
  "narrative-stale": { tone: "border-amber-200 bg-amber-50 text-amber-900", text: "A narrativa mudou em outra aba. Recarregue a página e revise antes de salvar." },
  ...
  "writes-disabled": { tone: "border-amber-200 bg-amber-50 text-amber-900", text: "A edição local não está habilitada neste ambiente." },
};
